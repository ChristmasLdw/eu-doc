    ...
    <div className="flex min-h-[calc(100vh-4rem)]">
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center p-12 text-white">
          ...
          <h1 className="text-4xl font-bold mb-4">{t("auth.signInTitle")}</h1>
          ...
          <div className="mt-12 grid grid-cols-3 gap-6 text-center">
            <div>
              ...
              <div className="text-sm text-blue-200">{t("home.stats.certificates")}</div>
            </div>
            <div>
              <div className="text-3xl font-bold">50+</div>
              <div className="text-sm text-blue-200">{t("home.stats.categories")}</div>
            </div>
            <div>
              <div className="text-3xl font-bold">500+</div>
              <div className="text-sm text-blue-200">{t("home.stats.companies")}</div>
            </div>
          </div>
        </div>
      </div>
