...
const content = {
  zh: {
    ...
    sections: [
      ...
      ['公开资料范围', ['EU-DOC 仅建议上传本来需要对客户、消费者、采购商或审核机构公开的产品资料，例如资质证书、DoC 声明、使用说明书及其他公开产品资料。', '请勿上传图纸、配方、BOM、供应商名单、报价、生产工艺、内部测试记录、客户合同、个人隐私或未公开新品资料等商业敏感内容。']],
