      ...
      <div className={styles.container}>
        ...
        <section className={styles.section}>
          ...
          <ul>
            ...
            <li>有权将该文档作为产品公开资料在 EU-DOC 平台上展示</li>
            <li>上传行为不违反任何内部规章制度或保密协议</li>
          </ul>
          <p>
            EU-DOC 仅建议上传本来需要对客户、消费者、采购商或审核机构公开的产品资料，
            例如资质证书、DoC 声明、使用说明书和公开检测报告。
          </p>
          <p className={styles.highlight}>
            <strong>请勿上传图纸、配方、BOM、供应商名单、报价、生产工艺、内部测试记录、客户合同、个人隐私或未公开新品资料等商业敏感内容。</strong>
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p>本人理解并同意：</p>
          <ul>
            <li>企业认证、资料公开、平台审核或页面展示，不代表平台对资料真实性或产品合规性作出背书</li>
            <li>如资料被举报、质疑或监管机构要求核查，平台有权先行隐藏、标记核查中或下架相关资料</li>
            <li>上传方应在平台要求的合理期限内提供原件、发证机构证明或其他补充资料</li>
            <li>上传方可在后台整理、更新、隐藏或下架资料，但对于已被第三方下载、截图或转发的内容，平台无法完全控制</li>
          </ul>
        </section>
