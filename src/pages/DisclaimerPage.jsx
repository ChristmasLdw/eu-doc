...
const content = {
  zh: {
    ...
    sections: [
      ['1. 平台定位', ['EU-DOC 是一个产品公开资料展示平台。我们为企业提供上传和展示产品认证证书、DoC 声明、产品使用说明书及其他公开产品资料的服务，为消费者、采购商和审批机构提供查询和验证产品合规性的渠道。', '本平台仅用于管理企业主动公开或适合对外展示的产品资料，不要求也不建议企业上传图纸、配方、BOM、供应商名单、报价、生产工艺、内部测试记录、客户合同、个人隐私或未公开新品资料等商业敏感内容。']],
      ['2. 企业认证与资料真实性', ['平台对企业身份、账号权限或入驻资料进行的审核，仅用于确认企业或账号的基本管理资格，不代表平台对该企业上传的任何证书、DoC 声明、说明书或其他公开产品资料的真实性、有效性、完整性、合法性或产品合规状态作出认证、保证或背书。', '除非平台以书面形式明确说明，任何“企业已认证”“资料已公开”“已审核”等状态，均不应被理解为平台确认该资料真实有效或确认相关产品符合法规要求。']],
