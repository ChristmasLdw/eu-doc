...
const scenarios = [
  ...
  {
    title: '面向企业的资料公开页',
    text: '企业可以为产品建立清晰的资料入口，让外部用户看到公开文件与基础产品信息。',
  },
];
  ...
  return (
    <main className={styles.page}>
      <section className={styles.hero}>
        ...
        <p>
          EU-DOC 面向需要公开产品资料的企业，帮助整理和展示产品相关的证书、DoC 声明、说明书等文件，
          让外部用户可以通过网页快速找到需要的公开资料。
        </p>
      ...
      <section className={styles.splitPanel}>
        <div>
          ...
          <h2>围绕“产品”组织文件</h2>
          <p>
            EU-DOC 不只是单个证书链接，而是围绕产品展示相关公开资料。用户可以先确认产品，再查看对应文件。
          </p>
        </div>
