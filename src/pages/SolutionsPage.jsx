...
const content = {
  zh: {
    ...
    documents: ['资质证书', 'DoC 符合性声明', '使用说明书', '产品基础资料'],
    positionTitle: '平台定位',
  ...
  en: {
    ...
    documents: ['Certificates', 'DoC Declaration', 'User Manual', 'Product Basics'],
  ...
  de: {
    ...
    documents: ['Zertifikate', 'Konformitätserklärungen', 'Bedienungsanleitungen', 'Produktinformationen'],
