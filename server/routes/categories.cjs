...
function ensureCategorySchema() {
  ...
  const complianceSeeds = [
    ...
    { name: 'EMC 电磁兼容', nameEn: 'EMC', slug: 'compliance-emc', description: '电磁兼容相关指令和标准' },
    { name: 'LVD 低电压', nameEn: 'LVD', slug: 'compliance-lvd', description: '低电压电气安全相关指令和标准' },
    { name: 'RED 无线设备', nameEn: 'RED', slug: 'compliance-red', description: '无线电设备相关指令和标准' },
    { name: 'RoHS / REACH', nameEn: 'RoHS / REACH', slug: 'compliance-rohs-reach', description: '有害物质限制与化学品合规' },
